...
默认输出目录：data_augmentation/Chembl_data/output/full_enrichment3/
"""
...
DEFAULT_OUT_DIR = CHEMBL_DATA_DIR / "output" / "full_enrichment3"
DEFAULT_SUMMARY = (
    CHEMBL_DATA_DIR
    / "output"
    / "full_enrichment1"
...
def main() -> None:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="默认 Chembl_data/output/full_enrichment3",
    )
    ...
    if args.max_molecules is not None:
        mol_order = mol_order[: max(0, int(args.max_molecules))]
